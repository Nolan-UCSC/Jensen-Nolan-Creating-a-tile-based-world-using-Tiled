class TinyTown extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("map", "TinyTownMapUpgrade.json"); 
    }
    ...
    create() {
        ...
        this.upgradeLayer = this.map.createLayer("upgraded-house", this.tileset, 0, 0);
        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.upgradeLayer.setScale(4.0);
        document.getElementById('description').innerHTML = '<h2>Welcome to Nolandia</h2>';
